                ...
                <div class="glass rounded-3xl p-8 shadow-2xl sticky top-5">
                    ...
                    <form method="POST" action="/sms/send" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="number" placeholder="+919876543210"
                        ...
                        <div>
                            ...
                            <textarea name="message" rows="6" maxlength="160" placeholder="Type your SMS..."
                ...
                <div class="glass rounded-3xl p-8 shadow-2xl">
                    ...
                    <div class="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-8">
                        ...
                        <form method="GET" action="/sms">
                            <input type="text" name="search" placeholder="Search number or message..."
                    ...
                    <div class="space-y-5">
                        ...
                        @forelse($messages as $msg)
                                            ...
                                            <div
                                                class="bg-slate-800/70 border border-slate-700 rounded-3xl p-5 hover:scale-[1.01] transition duration-300">
                                                ...
                                                <div class="flex flex-col md:flex-row justify-between gap-5">
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        <div class="flex items-center gap-3 mb-3">
                                                            ...
                                                            <div
                                                                class="bg-indigo-500 h-12 w-12 rounded-full flex items-center justify-center text-xl">
                                                                📱
                                                            </div>
                            ...
                            : 'bg-red-500/20 text-red-300 border border-red-400' }}">
                                                        ...
                                                        <!-- Delete -->
                                                        <form method="POST" action="/sms/{{ $msg->id }}" class="mt-6">

                                                            @csrf
                                                            @method('DELETE')

                                                            <button onclick="return confirm('Delete this SMS?')"
